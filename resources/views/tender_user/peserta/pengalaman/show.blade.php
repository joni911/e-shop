...
@include('tender_user.peserta.part.peserta-steps', ['steps' => $steps, 'activeKey' => 'pengalaman'])
...
<x-card title="Tambah Pengalaman">
    <form action="{{ route('pengalaman.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="d-flex gap-3 justify-content-end mt-4">
            <x-button label="Kembali" href="{{ route('peserta.edit', [$peserta->id]) }}" variant="secondary" icon="fas fa-arrow-left"/>
